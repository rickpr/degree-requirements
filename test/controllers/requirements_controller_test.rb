...
class RequirementsControllerTest < ActionController::TestCase
  ...
  test "should create requirement" do
    assert_difference('Requirement.count') do
      post :create, requirement: { hours: @requirement.hours, min_grade: @requirement.min_grade, name: @requirement.name, take: @requirement.take, type: @requirement.type }
    end
  ...
  test "should update requirement" do
    patch :update, id: @requirement, requirement: { hours: @requirement.hours, min_grade: @requirement.min_grade, name: @requirement.name, take: @requirement.take, type: @requirement.type }
    assert_redirected_to requirement_path(assigns(:requirement))
  end
